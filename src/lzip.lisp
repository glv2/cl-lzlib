             ...
             (read-member-size (pipe start)
               (logior (octet-streams:octet-stream-ref pipe start)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 1))
                            8)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 2))
                            16)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 3))
                            24)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 4))
                            32)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 5))
                            40)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 6))
                            48)
                       (ash (octet-streams:octet-stream-ref pipe (+ start 7))
                            56)))
